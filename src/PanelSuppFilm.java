...
public class PanelSuppFilm extends JPanel implements ActionListener{
	...
	public PanelSuppFilm(){
		
		this.setLayout(new FlowLayout());
		this.setBackground(Color.cyan);
		lblMsg1 = new JLabel("Suppression d'un film");
		this.add(lblMsg1);
		...
		but.add(jr2d);
		but.add(jr3d);
		jr2d.addActionListener(this);
		jr3d.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == btnValider){
			Model.suppFilm(jtfTitre.getText(),Integer.parseInt(jtfDuree.getText()), Integer.parseInt(jtfNbPlace.getText()), jr2d.isSelected(),jr3d.isSelected());
		}
